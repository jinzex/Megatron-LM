...
Example (cross-arch B300 vs H100):
    python plot_loss.py \\
        results/cross-arch/qwen3_0.6b_unfused_tp1_100iter_b300.log "B300 TP=1 (tp-invariant)" \\
        results/cross-arch/qwen3_0.6b_unfused_tp1_100iter_h100.log "H100 TP=1 (tp-invariant)" \\
        assets/b300_vs_h100_tp1_invariant.png
"""
import re
import sys
